# Cordova/PhoneGap sqlite storage adapter (xxx legacy-src)
...
- UNICODE `\u0000` (same as `\0`) character not working in Android (default native database implementation), Windows (8.1/XX), or WP(7/8)
