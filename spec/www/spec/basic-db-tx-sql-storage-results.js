...
// NOTE: In certain version branches there is no difference between the default
  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': BASIC db tx sql results test(s)', function() {
      ...
      describe(suiteName + 'STANDARD multi-row INSERT tests', function() {
        ...
        it(suiteName + 'INSERT OR IGNORE result in case of constraint violation [(WebKit) Web SQL DEVIATION on Android/iOS: reports old insertId value; WP8 TBD]', function(done) {
